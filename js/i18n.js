...
const TRANSLATIONS = {
  ...
  ug: {
    ...
    'program.start': 'Тойниң башлиниши',
    'program.asr': 'Әср намизи',
    'program.maghrib': 'Шам намизи',
    'program.note': 'Һөрмәтлик меһманлардан кечикмәсликни сораймиз. Той программисида намазларни оқуш үчүн қисқа тәнәппуслар қаралған.',
